...
public class Point {
    ...
    /**
     * Return a new Point that is a copy of this point with provided x-coordinate and the same y-coordinate as this
     * point. (Since the Point class is immutable, this provides a convenient alternative to a setter method.)
     * 
    ...
    /**
     * Return a new Point that is a copy of this point with provided y-coordinate and the same x-coordinate as this
     * point. (Since the Point class is immutable, this provides a convenient alternative to a setter method.)
     * 
     ...
     * @return a new Point object that has been moved according to the provided vector
     */
